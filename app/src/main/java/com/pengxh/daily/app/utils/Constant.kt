...
object Constant {
    ...
    const val TASK_DESIRED_RUNNING_KEY = "TASK_DESIRED_RUNNING_KEY"
    const val TASK_LAST_STOP_REASON_KEY = "TASK_LAST_STOP_REASON_KEY"
    const val TASK_LAST_STOP_DETAIL_KEY = "TASK_LAST_STOP_DETAIL_KEY"
    const val TASK_LAST_STOP_TIME_KEY = "TASK_LAST_STOP_TIME_KEY"
